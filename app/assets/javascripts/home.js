$(document).ready(function(){
  ...
  //   // alert("This is triggering a click event.")
  //   $(this).css("background", "url('/images/wave_1.jpg')");
  // });
  ...
  $('#animation').click(function() {
     var events = [fireA, fireB, fireC, fireD, fireE, fireF, fireG, fireH, fireI, fireJ, fireK, fireL, fireM, stop];

     //declare counter
     if(!this.counter) { this.counter = 0; }

     events[this.counter]();
     this.counter = (this.counter + 1) % 14;
  });
